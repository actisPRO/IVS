...
TEST(test,pow)
{
    double result[] = {-1500.15,0,314538177833.184387,11376388239525403636531200.00000,120815531657301110271508480.00000,0.0101633447686,0.018301086055103,1228401282807909867115002200064000.00000,23987202604909806707047591885108412416.00000,3220931248021127533046904541636365596115258228867072.0000,46966350.2399999946};
...
TEST(test,sqrt)
{
    double radicant[] = {112.0,2121.0,4543.0,454510.0,45454.0,455.0,456.0,212.0,4513.0,4514.0,12846.0};
    double result[] = {112.000000000000000,46.054315758677816,16.562055879867543,3.679208028803914,14.601350524779367,3.400965914550020,2.774347177725529,1.562648580388260,1.910349011372200,1.824064163487630,1.806333743276650};
    double valuesS[] = {1.0,2.0,3.0,10.0,4.0,5.0,6.0,12.0,13.0,14.0,16.0};
    for (int i = 0; i < 11; i++)
    {
        EXPECT_TRUE(Interval(m.sqrt(valuesS[i],radicant[i]), result[i]));
...
TEST(test,division)
{
    double result[] = {49.849497999999997,47465.459999999999127,30.367719769673705,265.180478582670162,-0.545203530118280,0.138213334382348,0.0000002575205346991,-0.000175826612903,-0.001879254790405,-0.102483016119373,-91328.556816993455868};

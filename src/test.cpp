...
TEST(test,sqrt)
{
    double valuesS[] = {10.2,22.3,30.0,1048.4165,415.1,0.1,6.576,121.156,131.1214,9714.131,7516.10217};
    double result[] = {10.199999999999999,4.722287581247038,3.107232505953859,2.004718437974307,4.513757087293679,0.630957344480193,1.368758935744237,1.491461603286670,1.455117177380882,1.926702089072596,1.746825576837161};
    double radicant[] = {1.0,2.0,3.0,10.0,4.0,5.0,6.0,12.0,13.0,14.0,16.0};
    for (int i = 0; i < 11; i++)
    {
